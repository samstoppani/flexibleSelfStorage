...
if(isset($_POST['email'])) {
    ...
    $email_to = "cbweldfab@gmail.com";
    $email_subject = "C. Benson Fabrication Enquiry";
 
    function died($error) {
        // error code
        echo "<body style=' background-color: #323F43;'>";
...
<body>
    <div class="row h-100" id="contactFormSent">§
        <div class="d-flex mx-auto align-items-center">
            <div class="col-12">
            <img src="images/logo.png" class="title wow fadeIn row mx-auto" data-wow-duration="2s" alt="C. Benson Fabrication">
                <br>
                <h4 class="text-center wow fadeInUp" data-wow-duration="2s">
